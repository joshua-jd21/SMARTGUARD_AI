...
# PURPOSE:
# ------------------------------------------------------------
# Streamlit dashboard for SmartGuard AI
#
# FEATURES:
# ------------------------------------------------------------
...
if run_pipeline and prediction:
        ...
        try:
            ...
            # =================================================
                ...
                with risk_col1:
                    ...
                    st.metric(
                        "CNN Confidence",
                        f"{rc.cnn_confidence:.2%}"
                    )

                    st.metric(
                        "Anomaly Score",
                        f"{rc.anomaly_score:.4f}"
                    )

                    st.metric(
                        "Claim Probability",
                        f"{ir.claim_probability}%"
                    )
                ...
                with risk_col2:
                    ...
                    st.metric(
                        "Premium Adjustment",
                        f"+{ir.premium_adjustment}%"
                    )

                    st.metric(
                        "Evidence Strength",
                        rr.evidence_strength
                    )

                    st.metric(
                        "Clinical Referral",
                        "YES"
                        if ir.clinical_referral
                        else "NO"
                    )
